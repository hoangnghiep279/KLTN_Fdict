...
import { getRecipesByNutrition } from "../api/linkrecipe/nutrition";
...
function Nutrition() {
  ...
  useEffect(() => {
    async function fetchData() {
      const response = await getRecipesByNutrition();
  ...
  return (
    <div className="container mx-auto py-10">
      <h1 className="text-3xl font-bold mb-6">Món ăn theo dinh dưỡng</h1>
