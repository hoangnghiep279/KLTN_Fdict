...
import { insertRecipe } from "../api/recipes/managerRecipe";
...
function InsertRecipe() {
  ...
  return (
    <div className="container py-5">
      <h1 className="text-2xl font-bold m-5 flex items-center gap-4">
        {" "}
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              className="w-[80%] p-2 bg-[#d3a48618] text-sm placeholder:text-gray-650 border outline-none rounded-lg my-2"
              type="file"
              name="img_url"
