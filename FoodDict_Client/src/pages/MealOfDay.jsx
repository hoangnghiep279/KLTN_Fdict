...
import { getRecipesByMealCate } from "../api/linkrecipe/mealOfDay";
...
function MealOfDay() {
  ...
  useEffect(() => {
    async function fetchData() {
      const response = await getRecipesByMealCate();
  ...
  return (
    <div className="container mx-auto py-10">
      <h1 className="text-3xl font-bold mb-6">Danh mục bữa trong ngày</h1>
