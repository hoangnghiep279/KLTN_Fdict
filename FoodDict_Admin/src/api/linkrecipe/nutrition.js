...
// 3. Thêm dinh dưỡng
const insertNutrition = async (nutrition) => {
  try {
...
const updateNutrition = async (id, nutrition) => {
  try {
    const response = await axios.put(`${API_URL}/${id}`, nutrition);
...
export { fetchNutrition, insertNutrition, updateNutrition, deleteNutrition };
