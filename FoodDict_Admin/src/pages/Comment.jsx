...
import { fetchComment, deleteComment } from "../api/commentApi";
...
function Comment() {
  ...
  const loadComment = async (page = 1) => {
    try {
      const res = await fetchComment(page, pagination.limit);
  ...
  const handleDeleteComment = async (commentId) => {
    ...
    if (result) {
      ...
      loadComment(pagination.page); // Reload lại trang hiện tại
    }
  };
